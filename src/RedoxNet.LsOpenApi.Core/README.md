...
| **Catalog** | `TrCatalog.Default` — 76-TR catalog as an embedded resource (시세 / 차트 / 지수 / 업종 / 테마 / ETF / 스크리너 / 종목조회 / 해외주식시세 / 해외주식차트 / 조건검색 / 계좌 / 기타). `Search` ranks by exact-code, name, category, description, and field-level matches. |

...
| **Catalog** | `TrCatalog.Default` — 18-TR seed catalog as an embedded resource (시세 / 차트 / 테마 / ETF / 종목조회 / 기타), including `t1531` and `t1532` theme classification TRs. `Search` ranks by exact-code, name, category, description, and field-level matches. |
